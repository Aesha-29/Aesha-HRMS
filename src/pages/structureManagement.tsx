...
function StructureManagement() {
    ...
    const handleMasterSave = async () => {
        try {
            ...
            await axios.post(`http://localhost:5000/api/${url}`, masterForm);
    ...
    const handleTransfer = async () => {
        ...
        try {
            ...
            await axios.post(`http://localhost:5000/api/${urlMapper[activeTab]}/bulk-transfer`, payload);
    ...
    return (
        <div className="structure-management-container">
            <h2 style={{ display: 'flex', alignItems: 'center', gap: '8px', margin: 0, marginBottom: '24px' }}>
                <Building2 size={32} color="#3b82f6" fill="#eff6ff" /> Structure Management Panel
            </h2>
