...
function Resignation() {
    ...
    const fetchData = async () => {
        ...
        try {
            if (activeTab === "Submit") {
                ...
                const res = await axios.get("http://localhost:5000/api/resignations");
    ...
    const handleSubmit = async () => {
        ...
        try {
            await axios.post("http://localhost:5000/api/resignations", formData);
    ...
    const handleApprove = async () => {
        try {
            await axios.put(`http://localhost:5000/api/resignations/${selectedResignation.id}/approve`, {
    ...
    const handleReject = async () => {
        ...
        try {
            await axios.put(`http://localhost:5000/api/resignations/${selectedResignation.id}/reject`, {
                remarks: reviewRemarks
            });
    ...
    return (
        <div className="resignation-container">
            <h2 style={{ display: 'flex', alignItems: 'center', gap: '8px', margin: 0, marginBottom: '24px' }}>
                <FileText size={32} color="#3b82f6" fill="#eff6ff" /> Employee Resignation Module
            </h2>
